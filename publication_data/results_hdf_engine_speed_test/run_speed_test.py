...
if __name__ == '__main__':
    ...
    max_coords = (30, 30)
    dims = ('lon', 'lat')
    filepath = '/Users/rileyhales/SpatialData/geojson/united_states.json'
    with open(filepath, 'w') as file:
        file.write(json.dumps(geomatics.data.get_livingatlas_geojson('United States')))
    # netcdf sample data
    files = sorted(glob.glob('/Users/rileyhales/SpatialData/thredds/timeseries-workshop/*.nc4'))
    data = {}
